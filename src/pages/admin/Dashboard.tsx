...
export default function Dashboard() {
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        const [menuItems, feedbackStats] = await Promise.all([
          getMenuItems(),
          getFeedbackStats(),
        ]);
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Welcome to SMASH&CO Admin Panel</p>
      </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Read and manage customer feedback</p>
                </div>
              </div>
            </a>
          </div>
